...
if __name__ == "__main__":
    ...
    train_df.to_csv("data/processed/train_weather.csv", index=True)
    val_df.to_csv("data/processed/val_weather.csv", index=True)

    print("Saved data/processed/train_weather.csv")
    print("Saved data/processed/val_weather.csv")

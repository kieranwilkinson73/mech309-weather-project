...
def preprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df.index.name = "time_local" ##ADDED
    ...
    #SEASONNAL CYCLE FEATURES
    df["sin_year"] = np.sin(omega_y * doy) #ADDED
    df["cos_year"] = np.cos(omega_y * doy) #ADDED
...
if __name__ == "__main__":
    ...
    ##SAVING TO FILE
    df_raw.to_csv("data/raw/montreal_weather_raw_2024_2025.csv") ##ADDDED
    df.to_csv("data/processed/montreal_weather_2024_2025.csv") ##ADDDED
    ##ADD LAG FEATURES?:

...
if __name__ == "__main__":
    ...
    for j in range(len(forecast_horizons)):
        model_root_error = rmse(y_val, y_predicted[j]) # Calculate the root mean square error of the predicted temperatures to the validation temperatures
        model_absolute_error = mae(y_val, y_predicted[j]) # Calculate the mean absolute error of the predicted temperatures to the validation temperatures
        baseline_root_error = rmse(y_val, T_baseline[j]) # Calculate the root mean square error of the baseline temperatures to the validation temperatures
        baseline_absolute_error = mae(y_val, T_baseline[j]) # Calculate the mean absolute error of the baseline temperatures to the validation temperatures
